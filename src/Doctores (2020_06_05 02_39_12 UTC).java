...
r2.equals(jTextField7.getText())||
r2.equals(jTextField8.getText()))
{
...
r.equals(jTextField7.getText())||
r.equals(jTextField8.getText()))
{
...
return;
        ...
        st.execute("Insert into doctores (id_doc,Nombre,Especialidad,Sueldo,Puesto,Cedula,Horario,Celular) VALUES ('"+jTextField1.getText()+"','"+jTextField2.getText()+"','"+jTextField4.getText()+"'"
                + ",'"+jTextField5.getText()+"','"+jTextField3.getText()+"','"+jTextField6.getText()+"','"+jTextField7.getText()+"','"+jTextField8.getText()+"') ");
    ...
    Statement st=con.createStatement();
    ResultSet rs=st.executeQuery("Select * from doctores where id_doc='"+jTextField1.getText()+"'");    
    
        if(rs.next()){
           aux=true;
           jTextField2.setText(rs.getString("Nombre"));
           jTextField4.setText(rs.getString("Especialidad"));
           jTextField5.setText(rs.getString("Sueldo"));
           jTextField3.setText(rs.getString("Puesto"));
           jTextField6.setText(rs.getString("Cedula"));
           jTextField7.setText(rs.getString("Horario"));
           jTextField8.setText(rs.getString("Celular"));
        } if(aux==false){
    ...
    try{
        ...
        Statement st=con.createStatement();
        st.execute("Update doctores set Nombre='"+jTextField2.getText()+"',Especialidad='"+jTextField4.getText()+"',sueldo='"+jTextField5.getText()+"',puesto='"+jTextField3.getText()+"',cedula='"+jTextField6.getText()+"',horario='"+jTextField7.getText()+"',celular='"+jTextField8.getText()+"'where id_doc='"+jTextField1.getText()+"'");
    ...
    private void initComponents() {
        ...
        jLabel10.setFont(new java.awt.Font("Yu Gothic UI Semilight", 2, 24)); // NOI18N
    ...
    private void jMenuItem3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem3ActionPerformed
        Reporte_Doctores bs=new Reporte_Doctores();
        bs.setVisible(true);
